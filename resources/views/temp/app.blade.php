...
<head>
  ...
  <title>{{ config('app.name', 'Comic Store') }}</title>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            if (!empty($order)) {
              ...
              $total_order = \App\Models\Detail_order::where('order_id', $order-> id) ->count();
            }
            ?>
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('checkout') }}">
                ...
                <span class="badge badge-warning ml-2 mb-2">{{ $total_order }}</span>
                @endif
              </a>
            </li>
