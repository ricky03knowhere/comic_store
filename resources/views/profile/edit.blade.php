            ...
            <div class="pl-lg-4">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input id="phone" type="number" class="form-control form-control-alternative" name="phone" value="{{ $user ->phone }}">
                </div>

              </div>

              <div class="form-group">
                <labeldo class="form-control-label" for="address">Address</label>
