...
!b(a.currentTarget).hasClass("disabled")&&o.page()!=a.data.action&&o.page(a.data.action).draw("page")};l=0;for(h=f.length;l<h;l++)if(c=f[l],b.isArray(c))q(d,c);else{g=e="";switch(c){case "ellipsis":e="&#x2026;";g="disabled";break;case "first":e='<b>First</b>';g=c+(0<j?"":" disabled");break;case "previous":e='<b>&#xab</b>';g=c+(0<j?"":" disabled");break;case "next":e='<b>&#xbb</b>';g=c+(j<n-1?"":" disabled");break;case "last":e='<b>Last</b>';g=c+(j<n-1?"":" disabled");break;default:e=c+1,g=j===c?"active":""}e&&(i=b("<li>",
